...
CREATE TABLE species (
    ...
    conservation_status TEXT CHECK (conservation_status IN ('Endangered', 'Vulnerable', 'Historic')) DEFAULT 'Vulnerable'
);
...
DELETE FROM rangers WHERE ranger_id NOT IN (SELECT DISTINCT sightings.ranger_id FROM sightings);
